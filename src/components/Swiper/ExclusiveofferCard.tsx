...
const ExlcusiveofferCard: React.FC = () => {
  return (
    <div className="w-[90%] h-[65vh] relative top-[-20px] border-green-600  m-auto  grid grid-cols-3 gap-1">
          ...
          return (
            <div className="w-[100%]  m-auto " key={game.id}>
              <div className="w-[100%]  border-yellow-600 h-[60vh]">
                ...
                <div className="w-[90.5%]  border-green-600 h-[4.7rem] m-auto mt-[-25px] text-center rounded-b-lg  border-white-500 play-button-exclusive">
